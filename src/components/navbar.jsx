  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed top-10 inset-x-0 mx-auto border border-transparent bg-[#F2F1EF] dark:border-white/[0.2] rounded-full bg-color1 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-4 pl-12 py-3 items-center justify-center space-x-5", // Adjusted padding and spacing
          className
        )}
      >
        {/* New website name item */}
        <div className="flex items-center space-x-3 text-black font-serif">
          {" "}
          {/* Adjusted spacing */}
          <span className="text-3xl font-extrabold font-cursive">
            Luno
          </span>{" "}
          {/* Adjusted font size */}
        </div>
        ...
        <motion.button
          href = "/sign-in"
          className="border text-sm font-medium relative border-neutral-200 bg-secondary bg-yellow-400 text-black px-5 py-3 rounded-full" // Adjusted padding
        >
